...
class TestWaarde(unittest.TestCase):
    ...
    def test_eenheid(self):
        assert Waarde(120).mm.eenheid == 'mm'
        assert Waarde(120, 'mm').eenheid == 'mm'
        w = Waarde(120).m
        w.eenheid = 'km'
        assert str(w) == '0.12 km'
        assert Waarde(120).eenheid is None
        assert Waarde('str').eenheid is None
    ...
    def test___iter__(self):
        ...
        assert (34.0, None) == tuple(Waarde(34))
        assert ('str', None) == tuple(Waarde('str'))
